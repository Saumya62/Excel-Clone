...
$(document).ready(function() {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    for (let j = 1; j <= 100; j++) {
      ...
      let coloumn = $(`<div class="input-cell" contenteditable="false" id = "row-${i}-col-${j}" data="code-${colCode}"></div>`)
      row.append(coloumn);
    }
    ...
    if ($(".sheet-options-modal").length == 0) {
      ...
      $(".sheet-rename").click(function() {
        $(".container").append(`<div class="sheet-rename-modal">
          ...
          <input type="text" name="" value="" class="new-sheet-name" placeholder="Sheet Name">
